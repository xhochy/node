...
<a id="10.20.0"></a>
## 2020-03-17, Version 10.20.0 'Dubnium' (LTS), @BethGriggs
...
* **deps**:
  ...
  * upgrade npm to 6.13.7 (Michael Perrotte) [#31558](https://github.com/nodejs/node/pull/31558)
* **n-api**:
...
* **tls**: support TLS min/max protocol defaults in CLI (Sam Roberts) [#27946](https://github.com/nodejs/node/pull/27946)
